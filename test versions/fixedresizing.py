...
class ToolTip:
    ...
    def show(self, event=None):
        ...
        label = tk.Label(self.tooltip, text=self.text, background="#e99dcb", 
...
class DrawingCanvas:
    ...
    def setup_layout(self):
        ...
        # Toolbar
        toolbar = tk.Frame(canvas_container, bg="#fefefe", height=40)
    ...
    def on_motion(self, event):
        """Handle mouse motion with smoother resizing"""
